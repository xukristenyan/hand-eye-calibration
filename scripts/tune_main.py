...
def main():
    ...
    x = tune_offsets[0] if tune_offsets[0] else None
    y = tune_offsets[1] if tune_offsets[1] else None
    z = tune_offsets[2] if tune_offsets[2] else None

    transform = tune_transform(transform, x=x, y=y, z=z)
